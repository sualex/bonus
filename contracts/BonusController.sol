...
contract BonusController {
    ...
    function BonusController(address a) public {
        tokenContractAddress = a;
    }
    // bonus calculation - should be overridable
    function calculateBonus(uint pSum) pure internal returns (uint)  {
        uint result = 0;
    ...
    function charge(address bonusReceiver, uint purchaseSum) public returns (uint){
